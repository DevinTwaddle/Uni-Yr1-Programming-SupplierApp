...
public class Supplier {
	...
	public String getFullSupplierDetails() {
		return ("\n---------------------\nSupplier Code: " + getSupCode() + "\n---------------------\nName: " + getSupName()
				+ "\nRegion: " + getSupRegion().getRegionAsString() + getSupAddress().getFullAddress() + "\n\n");
	}
	
	public String getPartialSupplierDetails() {
		return ("\n---------------------\n Supplier Code: " + getSupCode() + " \n---------------------"
				+ "\nName: " + getSupName() 
				+ "\nRegion: " + getSupRegion().getRegionAsString());
	}
